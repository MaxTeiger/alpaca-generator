...
!(function (A, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((A =
        "undefined" != typeof globalThis ? globalThis : A || self).html2canvas =
        e());
})(this, function () {
  "use strict";
  /*! *****************************************************************************
  ...
  var d =
    ((r.prototype.add = function (A, e, t, B) {
      return new r(
        this.left + A,
        this.top + e,
        this.width + t,
    ...
    (r.fromDOMRectList = function (A, e) {
      ...
      return e
        ? new r(
            e.x + A.windowBounds.left,
            e.y + A.windowBounds.top,
            e.width,
            e.height
          )
        : r.EMPTY;
      ...
      ((F = (function (A) {
        ...
        for (
          ...
          (e = c[A.charCodeAt(Q)]),
            ...
            (B = c[A.charCodeAt(Q + 2)]),
            (r = c[A.charCodeAt(Q + 3)]),
            (i[o++] = (e << 2) | (t >> 4)),
            (i[o++] = ((15 & t) << 4) | (B >> 2)),
            (i[o++] = ((3 & B) << 6) | (63 & r));
        return n;
        ...
        for (
          ...
          (A = (function (A, e, t, B, r) {
            ...
            if (
              ...
              return q;
            if (
              (i === G && -1 !== [X, k, R].indexOf(r)) ||
              (-1 !== [X, k, R].indexOf(i) && r === T)
            )
              return q;
            if (
              (-1 !== z.indexOf(i) && -1 !== eA.indexOf(r)) ||
              (-1 !== eA.indexOf(i) && -1 !== z.indexOf(r))
            )
              return q;
            if (
              (-1 !== [G, T].indexOf(i) &&
                (r === S || (-1 !== [x, K].indexOf(r) && e[1 + o] === S))) ||
              (-1 !== [x, K].indexOf(i) && r === S) ||
            ...
            if (
              (J === i && -1 !== [J, Y, P, N].indexOf(r)) ||
              (-1 !== [Y, P].indexOf(i) && -1 !== [Y, W].indexOf(r)) ||
              (-1 !== [W, N].indexOf(i) && r === W)
            )
              return q;
            if (
              (-1 !== BA.indexOf(i) && -1 !== [D, T].indexOf(r)) ||
              (-1 !== BA.indexOf(r) && i === G)
            )
              return q;
  ...
  var lA = { type: 2 },
    ...
    GA =
      ...
      (OA.prototype.consumeToken = function () {
        ...
        switch (A) {
          ...
          case 64:
            ...
            if (UA(n, o, i)) return { type: 7, value: this.consumeName() };
            break;
          case 91:
            return xA;
          case 92:
      ...
      (OA.prototype.consumeCodePoint = function () {
        var A = this._value.shift();
        return void 0 === A ? -1 : A;
      }),
      (OA.prototype.reconsumeCodePoint = function (A) {
        this._value.unshift(A);
      }),
      (OA.prototype.peekCodePoint = function (A) {
        return A >= this._value.length ? -1 : this._value[A];
      }),
      (OA.prototype.consumeUnicodeRangeToken = function () {
        for (var A = [], e = this.consumeCodePoint(); QA(e) && A.length < 6; )
        ...
        if (45 === this.peekCodePoint(0) && QA(this.peekCodePoint(1))) {
          this.consumeCodePoint();
          for (var e = this.consumeCodePoint(), r = []; QA(e) && r.length < 6; )
            r.push(e), (e = this.consumeCodePoint());
          return { type: 30, start: B, end: parseInt(g.apply(void 0, r), 16) };
        }
        return { type: 30, start: B, end: B };
      }),
      (OA.prototype.consumeIdentLikeToken = function () {
      ...
      (OA.prototype.consumeUrlToken = function () {
        var A = [];
      ...
      (OA.prototype.consumeWhiteSpace = function () {
        for (; cA(this.peekCodePoint(0)); ) this.consumeCodePoint();
      }),
      (OA.prototype.consumeBadUrlRemnants = function () {
        for (;;) {
          var A = this.consumeCodePoint();
          if (41 === A || -1 === A) return;
      ...
      (OA.prototype.consumeStringSlice = function (A) {
        for (var e = ""; 0 < A; ) {
      ...
      (OA.prototype.consumeStringToken = function (A) {
        for (var e = "", t = 0; ; ) {
          var B,
            r = this._value[t];
          if (-1 === r || void 0 === r || r === A)
      ...
      (OA.prototype.consumeNumber = function () {
        var A = [],
          e = 4;
        for (
      ...
      (OA.prototype.consumeNumericToken = function () {
      ...
      (OA.prototype.consumeEscapedCodePoint = function () {
        var A,
          e = this.consumeCodePoint();
        if (QA(e)) {
          for (var t = g(e); QA(this.peekCodePoint(0)) && t.length < 6; )
            t += g(this.consumeCodePoint());
          cA(this.peekCodePoint(0)) && this.consumeCodePoint();
          var B = parseInt(t, 16);
          return 0 === B || (55296 <= (A = B) && A <= 57343) || 1114111 < B
            ? 65533
            : B;
        }
        return -1 === e ? 65533 : e;
      }),
      (OA.prototype.consumeName = function () {
        for (var A = ""; ; ) {
  ...
  var VA =
    ...
    (kA.parseValue = function (A) {
      return kA.create(A).parseComponentValue();
    }),
    (kA.parseValues = function (A) {
      return kA.create(A).parseComponentValues();
    }),
    (kA.prototype.parseComponentValue = function () {
    ...
    (kA.prototype.parseComponentValues = function () {
      for (var A = []; ; ) {
        var e = this.consumeComponentValue();
    ...
    (kA.prototype.consumeComponentValue = function () {
    ...
    (kA.prototype.consumeSimpleBlock = function (A) {
    ...
    (kA.prototype.consumeFunction = function (A) {
    ...
    (kA.prototype.consumeToken = function () {
      var A = this._tokens.shift();
      return void 0 === A ? TA : A;
    }),
    (kA.prototype.reconsumeToken = function (A) {
  ...
  var re = function (A, e) {
    ...
    ge = function (A, e, t, B) {
      return (
        ((A << 24) | (e << 16) | (t << 8) | (Math.round(255 * B) << 0)) >>> 0
      );
    },
    we = function (A, e) {
      e = e.filter(WA);
  ...
  function ue(A, t) {
    ...
    for (var r = [], n = 0, s = 0; s < A.length; s++) {
      var o = A[s].stop;
      null !== o
        ? (n < (o = ie(o, t)) ? r.push(o) : r.push(n), (n = o))
        : r.push(null);
    }
    ...
    return A.map(function (A, e) {
      return { color: A.color, stop: Math.max(Math.min(1, r[e] / t), 0) };
    });
  }
  function Fe(A, e, t) {
    var B =
  ...
  var fe = function (A, e) {
      var t = e.filter(WA),
        ...
        A = qA(r) ? r.number / 100 : 0,
        B = qA(n) ? n.number / 100 : 0,
        r = void 0 !== e && qA(e) ? ie(e, 1) : 1;
      if (0 == A) return ge(255 * B, 255 * B, 255 * B, 1);
      (n = B <= 0.5 ? B * (1 + A) : B + A - B * A),
        (e = 2 * B - n),
        (A = Ue(e, n, t + 1 / 3)),
        (B = Ue(e, n, t)),
        (t = Ue(e, n, t - 1 / 3));
    ...
    He = { hsl: fe, hsla: fe, rgb: we, rgba: we },
    pe = {
        ...
        ZA(A).forEach(function (A, e) {
          ...
          0 === e
            ? (t = A.reduce(function (A, e) {
                ...
                else if (qA(e) || _A(e)) return o.push(e), !1;
                return A;
              }, t))
            : 1 === e &&
              (t = A.reduce(function (A, e) {
    ...
    Me = {
      ...
      "-webkit-gradient": function (B, A) {
        ...
        return (
          ...
          1 === n
            ? { angle: (e + ce(180)) % ce(360), stops: r, type: n }
  ...
  var Vt = {
    ...
    tB = {
      ...
      parse: function (A, e) {
        var t = [];
        return (
          e.filter(NA).forEach(function (A) {
            switch (A.value) {
              case "stroke":
                t.push(1);
                break;
    ...
    nB =
      ((sB.prototype.isVisible = function () {
        return 0 < this.display && 0 < this.opacity && 0 === this.visibility;
      }),
      (sB.prototype.isTransparent = function () {
        return ee(this.backgroundColor);
      }),
      (sB.prototype.isTransformed = function () {
        return null !== this.transform;
      }),
      (sB.prototype.isPositioned = function () {
        return 0 !== this.position;
      }),
      (sB.prototype.isPositionedWithZIndex = function () {
        return this.isPositioned() && !this.zIndex.auto;
      }),
      (sB.prototype.isFloating = function () {
        return 0 !== this.float;
      }),
      (sB.prototype.isInlineLevel = function () {
        return (
          Gt(this.display, 4) ||
          Gt(this.display, 33554432) ||
          Gt(this.display, 268435456) ||
          Gt(this.display, 536870912) ||
          Gt(this.display, 67108864) ||
          Gt(this.display, 134217728)
        );
      }),
      sB);
  function sB(A, e) {
    (this.animationDuration = QB(A, $t, e.animationDuration)),
      ...
      (this.boxShadow = QB(A, eB, e.boxShadow)),
      (this.color = QB(A, ot, e.color)),
      (this.direction = QB(A, it, e.direction)),
      (this.display = QB(A, Qt, e.display)),
      (this.float = QB(A, at, e.cssFloat)),
    ...
    (this.overflowX = t[0]),
      ...
      (this.wordBreak = QB(A, Vt, e.wordBreak)),
      (this.zIndex = QB(A, kt, e.zIndex));
  }
  for (
    var oB = function (A, e) {
      ...
      next: function () {
        ...
        for (
          ...
          (A = (function (A, e) {
            ...
            if (r === DB && -1 !== [DB, vB, xB, MB].indexOf(e)) return TB;
            if (!((r !== xB && r !== vB) || (e !== vB && 10 !== e))) return TB;
  ...
  var IB,
    ...
    SB =
      ((KB = (function (A) {
        ...
        for (
          ...
          (e = wB[A.charCodeAt(Q)]),
            (t = wB[A.charCodeAt(Q + 1)]),
            (B = wB[A.charCodeAt(Q + 2)]),
            (r = wB[A.charCodeAt(Q + 3)]),
            (i[o++] = (e << 2) | (t >> 4)),
            (i[o++] = ((15 & t) << 4) | (B >> 2)),
            (i[o++] = ((3 & B) << 6) | (63 & r));
        return n;
    ...
    VB = {
      get SUPPORT_RANGE_BOUNDS() {
        ...
        return (
          Object.defineProperty(VB, "SUPPORT_RANGE_BOUNDS", { value: A }), A
        );
      },
      get SUPPORT_WORD_BREAKING() {
        ...
        return (
          Object.defineProperty(VB, "SUPPORT_WORD_BREAKING", { value: A }), A
        );
      },
      get SUPPORT_SVG_DRAWING() {
        ...
        return (
          Object.defineProperty(VB, "SUPPORT_SVG_DRAWING", { value: A }), A
        );
      },
      get SUPPORT_FOREIGNOBJECT_DRAWING() {
        var A =
          "function" == typeof Array.from && "function" == typeof window.fetch
                  ...
                  OB(e)
                    .then(function (A) {
                      ...
                      return (
                        ...
                        EB(e) ? OB(GB(B, B, 0, 0, A)) : Promise.reject(!1)
                      );
                    })
                    .then(function (A) {
                      return (
            ...
            : Promise.resolve(!1);
        return (
          Object.defineProperty(VB, "SUPPORT_FOREIGNOBJECT_DRAWING", {
            value: A,
          }),
          A
        );
      ...
      get SUPPORT_CORS_IMAGES() {
        ...
        return (
          Object.defineProperty(VB, "SUPPORT_CORS_IMAGES", { value: A }), A
        );
      },
      get SUPPORT_RESPONSE_TYPE() {
        var A = "string" == typeof new XMLHttpRequest().responseType;
        return (
          Object.defineProperty(VB, "SUPPORT_RESPONSE_TYPE", { value: A }), A
        );
      },
    ...
    JB = [32, 160, 4961, 65792, 65793, 4153, 4241],
    YB = function (A, e) {
      for (
        var t,
          B = oA(A, {
                ...
                ? VB.SUPPORT_WORD_BREAKING
                  ...
                  : s.push(
                      new kB(
                        ...
                        d.fromDOMRectList(
                          B,
                          PB(n, o, A.length).getClientRects()
                        )
                      )
                    )
                : ((e = n.splitText(A.length)),
                  s.push(new kB(A, RB(B, n))),
                  (n = e))
  ...
  function rr(A, e) {
    ...
    return (
      ...
      (t.svg =
        "data:image/svg+xml," + encodeURIComponent(B.serializeToString(e))),
  ...
  var ar,
    gr = [{ type: 15, flags: 0, unit: "px", number: 3 }],
    wr = [{ type: 16, flags: 0, number: 50 }],
    Ur = "checkbox",
    Cr = "radio",
    lr = "password",
    ur = 707406591,
  ...
  function mr(A, e) {
    var t,
      B,
      r = yr.call(this, A, e) || this;
    (r.src = e.src),
      (r.width = parseInt(e.width, 10) || 0),
  ...
  var br = ["OL", "UL", "MENU"],
          ...
          : Gr(r) &&
            (qr(r) && r.assignedNodes
              ...
              : (n = vr(e, r)).styles.isVisible() &&
                (Mr(r, n, B) ? (n.flags |= 4) : Sr(n.styles) && (n.flags |= 2),
    ...
    jr =
      ((zr.prototype.getCounterValue = function (A) {
        A = this.counters[A];
        return A && A.length ? A[A.length - 1] : 1;
      }),
      (zr.prototype.getCounterValues = function (A) {
        A = this.counters[A];
        return A || [];
      }),
      (zr.prototype.pop = function (A) {
        var e = this;
        A.forEach(function (A) {
          return e.counters[A].pop();
        });
      }),
      (zr.prototype.parse = function (A) {
        var t = this,
  ...
  var rn,
    ...
    wn =
      ((Un.prototype.toIFrame = function (A, B) {
        var e = this,
          r = ln(A, B);
        if (!r.contentWindow)
            ...
            return a(e, void 0, void 0, function () {
              ...
              return H(this, function (A) {
                switch (A.label) {
                  case 0:
                    return (
                      this.scrolledElements.forEach(pn),
                      s &&
                        (s.scrollTo(B.left, B.top),
                        !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) ||
                          (s.scrollY === B.top && s.scrollX === B.left) ||
      ...
      (Un.prototype.createElementClone = function (A) {
      ...
      (Un.prototype.createStyleClone = function (A) {
        try {
          var e = A.sheet;
          if (e && e.cssRules) {
      ...
      (Un.prototype.createCanvasClone = function (e) {
        var A;
      ...
      (Un.prototype.cloneNode = function (A) {
        ...
        if (e && Gr(A) && (Or(A) || Vr(A))) {
          ...
          this.referenceElement === A &&
            ...
            Xr(t) && Kn(t);
          for (
            var e = this.counters.parse(new iB(this.context, B)),
          ...
          return (
            n && t.appendChild(n),
            this.counters.pop(e),
            B && (this.options.copyStyles || Vr(A)) && !Wr(A) && dn(B, t),
            (0 === A.scrollTop && 0 === A.scrollLeft) ||
              this.scrolledElements.push([t, A.scrollLeft, A.scrollTop]),
            (Zr(A) || _r(A)) && (Zr(t) || _r(t)) && (t.value = A.value),
            t
          );
        }
        return A.cloneNode(!1);
      }),
      (Un.prototype.resolvePseudoContent = function (o, A, e, t) {
        var i = this;
        if (e) {
          var B = e.content,
            Q = A.ownerDocument;
          if (
            ...
            dn(e, a),
              c.content.forEach(function (A) {
                if (0 === A.type) a.appendChild(Q.createTextNode(A.value));
                  ...
                  "attr" === A.name
                    ...
                    : "counter" === A.name
                    ? ((r = (B = A.values.filter(WA))[0]),
                      (B = B[1]),
                      r &&
                        NA(r) &&
                        ((t = i.counters.getCounterValue(r.value)),
                        (s = B && NA(B) ? ut.parse(i.context, B.value) : 3),
                        a.appendChild(Q.createTextNode(an(t, s, !1)))))
                    : "counters" === A.name &&
                      ((r = (t = A.values.filter(WA))[0]),
                      (s = t[1]),
                      (B = t[2]),
                      r &&
                        NA(r) &&
                        ((r = i.counters.getCounterValues(r.value)),
                        (n = B && NA(B) ? ut.parse(i.context, B.value) : 3),
                  ...
                  switch (A.value) {
                    case "open-quote":
                      a.appendChild(
                        Q.createTextNode(Ot(c.quotes, i.quoteDepth++, !0))
                      );
                      break;
                    case "close-quote":
                      a.appendChild(
                        Q.createTextNode(Ot(c.quotes, --i.quoteDepth, !1))
                      );
                      break;
                    default:
              ...
              (a.className = En + " " + In);
            t = t === rn.BEFORE ? " " + En : " " + In;
            return Vr(A) ? (A.className.baseValue += t) : (A.className += t), a;
          }
        }
      }),
      (Un.destroy = function (A) {
  ...
  var Dn =
          ...
          switch (A.label) {
            case 0:
              ...
              (t =
                ...
                VB.SUPPORT_CORS_XHR &&
                !B),
              e || !1 !== this._options.allowTaint || Gn(s) || Vn(s) || t || B)
    ...
    (vn.prototype.proxy = function (s) {
      ...
      return new Promise(function (e, t) {
        ...
        r.open(
          "GET",
          i + n + "url=" + encodeURIComponent(s) + "&responseType=" + B
        ),
          "text" != B && r instanceof XMLHttpRequest && (r.responseType = B),
  ...
  var xn = /^data:image\/svg\+xml/i,
    Mn = /^data:image\/.*;base64,/i,
    Sn = /^data:image\/.*/i,
    Tn = function (A) {
  ...
  var Xn =
    ...
    (Jn.prototype.reverse = function () {
      return new Jn(this.end, this.endControl, this.startControl, this.start);
    }),
    Jn);
  function Jn(A, e, t, B) {
    (this.type = 1),
  ...
  var Wn,
    Zn = function (A) {
      var e = A.styles,
        t = A.bounds,
        B = (l = zA(e.borderTopLeftRadius, t.width, t.height))[0],
        r = l[1],
        n = (u = zA(e.borderTopRightRadius, t.width, t.height))[0],
        s = u[1],
        o = (F = zA(e.borderBottomRightRadius, t.width, t.height))[0],
        i = F[1],
        Q = (h = zA(e.borderBottomLeftRadius, t.width, t.height))[0],
        c = h[1];
      (d = []).push((B + n) / t.width),
        d.push((Q + o) / t.width),
        d.push((r + c) / t.height),
      ...
      (this.topLeftBorderDoubleOuterBox =
        ...
        (this.topRightPaddingBox =
          0 < n || 0 < s
            ? $n(
                t.left + Math.min(a, t.width - l),
                t.top + C,
                a > t.width + l ? 0 : Math.max(0, n - l),
                Math.max(0, s - C),
                Wn.TOP_RIGHT
              )
  ...
  var $n = function (A, e, t, B, r) {
    ...
    rs =
      ((ns.prototype.getEffects = function (e) {
        for (
  ...
  function is(A) {
    var e = A.styles,
      t = A.bounds,
      B = ie(e.paddingLeft, t.width),
      r = ie(e.paddingRight, t.width),
      n = ie(e.paddingTop, t.width),
  ...
  var gs = function (Q, c, a, g) {
          ...
          ? ((r = e || A.styles.isPositioned() ? a : c),
            ...
            A.styles.isTransformed()
              ? (n = A.styles.zIndex.order) < 0
                ? ((s = 0),
                  r.negativeZIndex.some(function (A, e) {
                ...
                : 0 < n
                ? ((o = 0),
                  r.positiveZIndex.some(function (A, e) {
                    return n >= A.element.container.styles.zIndex.order
                      ? ((o = e + 1), !1)
                      : 0 < o;
                  }),
    ...
    ws = function (A, e) {
      for (
        var t = A instanceof Qr ? A.start : 1,
          B = A instanceof Qr && A.reversed,
          r = 0;
        r < e.length;
        r++
      ) {
        var n = e[r];
        n.container instanceof sr &&
    ...
    Us = function (A, e) {
      var t = [];
      return (
        Yn(A) ? t.push(A.subdivide(0.5, !1)) : t.push(A),
        Yn(e) ? t.push(e.subdivide(0.5, !0)) : t.push(e),
        t
      );
    },
    Cs = function (A, e, t, B) {
      var r = [];
      return (
        Yn(A) ? r.push(A.subdivide(0.5, !1)) : r.push(A),
        Yn(t) ? r.push(t.subdivide(0.5, !0)) : r.push(t),
        Yn(B) ? r.push(B.subdivide(0.5, !0).reverse()) : r.push(B),
        Yn(e) ? r.push(e.subdivide(0.5, !1).reverse()) : r.push(e),
        r
      );
    },
    ls = function (A, e, t) {
      ...
      if (NA(s) && (s.value === xe.CONTAIN || s.value === xe.COVER))
        return as(n)
          ? t.width / t.height < n != (s.value === xe.COVER)
            ? [t.width, t.width / n]
            : [t.height * n, t.height]
          : [t.width, t.height];
      var Q = as(B),
      ...
      if (i) {
        var c = 0,
          a = 0;
        return (
          qA(s) ? (c = ie(s, t.width)) : qA(o) && (a = ie(o, t.height)),
          cs(s) ? (c = a * n) : (o && !cs(o)) || (a = c / n),
          [c, a]
        );
      }
      (c = null), (a = null);
      if (
        (qA(s) ? (c = ie(s, t.width)) : o && qA(o) && (a = ie(o, t.height)),
        null !==
          (c =
            null !==
              (a =
      ...
      switch (A) {
        ...
        default:
          return [
            ...
            new Rn(Math.round(r.left + r.width), Math.round(r.height + r.top)),
    ...
    hs = "Hidden Text",
    ds =
      ((fs.prototype.parseMetrics = function (A, e) {
        ...
        return n.removeChild(t), { baseline: e, middle: B };
      }),
      (fs.prototype.getMetrics = function (A, e) {
        var t = A + " " + e;
        return (
  ...
  var Hs,
    ...
    ps =
      ...
      (Es.prototype.popEffect = function () {
        this._activeEffects.pop(), this.ctx.restore();
      }),
      (Es.prototype.renderStack = function (e) {
        return a(this, void 0, void 0, function () {
          return H(this, function (A) {
            switch (A.label) {
              case 0:
      ...
      (Es.prototype.renderNode = function (e) {
        return a(this, void 0, void 0, function () {
          return H(this, function (A) {
            switch (A.label) {
              case 0:
                return (
                  Gt(e.container.flags, 16),
      ...
      (Es.prototype.renderTextWithLetterSpacing = function (t, A, B) {
        var r = this;
        0 === A
          ? this.ctx.fillText(t.text, t.bounds.left, t.bounds.top + B)
          : pB(t.text).reduce(function (A, e) {
              return (
                r.ctx.fillText(e, A, t.bounds.top + B),
                A + r.ctx.measureText(e).width
              );
            }, t.bounds.left);
      }),
      (Es.prototype.createFontStyle = function (A) {
        var e = A.fontVariant
            .filter(function (A) {
      ...
      (Es.prototype.renderTextNode = function (i, Q) {
        return a(this, void 0, void 0, function () {
          var e,
            t,
            B,
                  ...
                  switch (A) {
                    case 0:
                      (o.ctx.fillStyle = te(Q.color)),
                        o.renderTextWithLetterSpacing(t, Q.letterSpacing, r);
                      var e = Q.textShadow;
                      e.length &&
                        t.text.trim().length &&
                        (e
                    ...
                    case 1:
                      Q.webkitTextStrokeWidth &&
                        t.text.trim().length &&
                        ((o.ctx.strokeStyle = te(Q.webkitTextStrokeColor)),
      ...
      (Es.prototype.renderReplacedElement = function (A, e, t) {
        var B;
        t &&
          0 < A.intrinsicWidth &&
          0 < A.intrinsicHeight &&
      ...
      (Es.prototype.renderNodeContent = function (w) {
        return a(this, void 0, void 0, function () {
            ...
            switch (A.label) {
              ...
              case 19:
                w.listValue &&
                  ...
                  (g = new d(
                    e.bounds.left,
                    e.bounds.top + ie(e.styles.paddingTop, e.bounds.width),
                    e.bounds.width,
                    ke(B.lineHeight, B.fontSize.number) / 2 + 1
                  )),
                  this.renderTextWithLetterSpacing(
                    new kB(w.listValue, g),
                    B.letterSpacing,
      ...
      (Es.prototype.renderStackContent = function (l) {
        return a(this, void 0, void 0, function () {
          ...
          return H(this, function (A) {
            switch (A.label) {
              case 0:
                return (
                  Gt(l.element.container.flags, 16),
              ...
              case 22:
                (a = 0),
                  (g = l.zeroOrAutoZIndexOrTransformedOrOpacity),
                  (A.label = 23);
              case 23:
                return a < g.length
      ...
      (Es.prototype.path = function (A) {
        this.ctx.beginPath(), this.formatPath(A), this.ctx.closePath();
      }),
      (Es.prototype.formatPath = function (A) {
        var B = this;
        A.forEach(function (A, e) {
      ...
      (Es.prototype.renderRepeat = function (A, e, t, B) {
        this.path(A),
      ...
      (Es.prototype.resizeImage = function (A, e, t) {
        ...
        return (
          ...
          (B.height = Math.max(1, t)),
          B.getContext("2d").drawImage(A, 0, 0, A.width, A.height, 0, 0, e, t),
          B
        );
      }),
      (Es.prototype.renderBackgroundImage = function (f) {
        return a(this, void 0, void 0, function () {
          var h, e, d, t, B, r;
          return H(this, function (A) {
            switch (A.label) {
              case 0:
                (h = f.styles.backgroundImage.length - 1),
                  (e = function (e) {
                    var t, B, r, n, s, o, i, Q, c, a, g, w, U, C, l, u, F;
                    return H(this, function (A) {
                      switch (A.label) {
                        case 0:
                        ...
                        case 5:
                          1 === e.type
                            ? ((F = Qs(f, h, [null, null, null])),
                              ...
                              (u = l[3]),
                              (Q = l[4]),
                              ((F = document.createElement("canvas")).width =
                                c),
                              (F.height = a),
                              (l = F.getContext("2d")),
                              (n = l.createLinearGradient(r, u, i, Q)),
                              ue(e.stops, C).forEach(function (A) {
                                return n.addColorStop(A.stop, te(A.color));
                              }),
                              (l.fillStyle = n),
                              l.fillRect(0, 0, c, a),
                              0 < c &&
                            ...
                            : 2 === e.type &&
                              ...
                              (c = u[3]),
                              (a = u[4]),
                              (C = 0 === e.position.length ? [se] : e.position),
                              (g = ie(C[0], c)),
                              (w = ie(C[C.length - 1], a)),
                              (l = (function (A, e, t, B, r) {
                                var n,
                                  s,
                                  o,
                                  i,
                              ...
                              0 < F &&
                                ...
                                ue(e.stops, 2 * F).forEach(function (A) {
                                  return U.addColorStop(A.stop, te(A.color));
                                }),
                                d.path(o),
                                (d.ctx.fillStyle = U),
                                F !== u
                                  ? ((C = f.bounds.left + 0.5 * f.bounds.width),
                                    (l = f.bounds.top + 0.5 * f.bounds.height),
                                    (F = 1 / (u = u / F)),
                                    d.ctx.save(),
                                    d.ctx.translate(C, l),
      ...
      (Es.prototype.renderSolidBorder = function (e, t, B) {
        return a(this, void 0, void 0, function () {
          return H(this, function (A) {
            return (
              this.path(ss(B, t)),
      ...
      (Es.prototype.renderDoubleBorder = function (t, B, r, n) {
        return a(this, void 0, void 0, function () {
          var e;
          return H(this, function (A) {
            switch (A.label) {
              case 0:
                return B < 3 ? [4, this.renderSolidBorder(t, r, n)] : [3, 2];
              case 1:
                return A.sent(), [2];
              case 2:
                return (
      ...
      (Es.prototype.renderNodeBackgroundAndBorders = function (c) {
        return a(this, void 0, void 0, function () {
          var e,
            t,
            B,
          ...
          return H(this, function (A) {
            switch (A.label) {
                    ...
                    .forEach(function (A) {
                      ...
                      var t,
                        ...
                        o =
                          ...
                          (B = (A.inset ? 1 : -1) * A.spread.number),
                          (r = A.spread.number * (A.inset ? -2 : 2)),
              ...
              case 3:
                return s < o.length
                  ? 0 !== (i = o[s]).style && !ee(i.color) && 0 < i.width
                    ? 2 !== i.style
                      ? [3, 5]
                      : [
                          4,
      ...
      (Es.prototype.renderDashedDottedBorder = function (g, w, U, C, l) {
        return a(this, void 0, void 0, function () {
          ...
          return H(this, function (A) {
            return (
              ...
              (Q = (function (A, e) {
                switch (e) {
                  case 0:
                    return Us(A.topLeftBorderStroke, A.topRightBorderStroke);
                  case 1:
                    return Us(
                  ...
                  default:
                    return Us(A.bottomLeftBorderStroke, A.topLeftBorderStroke);
                }
              })(C, U)),
              (e = ss(C, U)),
              ...
              (s = Yn(e[0])
                ...
                : ((t = e[0].x), e[0].y)),
              (o = Yn(e[1])
                ? ((B = e[1].end.x), e[1].end.y)
                : ((B = e[1].x), e[1].y)),
              (r = 0 === U || 2 === U ? Math.abs(t - B) : Math.abs(s - o)),
              this.ctx.beginPath(),
              3 === l ? this.formatPath(Q) : this.formatPath(e.slice(0, 2)),
              (n = w < 3 ? 3 * w : 2 * w),
              (s = w < 3 ? 2 * w : w),
              3 === l && (s = n = w),
              (o = !0),
      ...
      (Es.prototype.render = function (r) {
        return a(this, void 0, void 0, function () {
          return H(this, function (A) {
            switch (A.label) {
              case 0:
  ...
  var Is,
    ys = function (A) {
      return (
        A instanceof Er ||
        A instanceof fr ||
        (A instanceof Fr && A.type !== Cr && A.type !== Ur)
      );
    },
    Ks = function (A, e) {
      switch (A) {
  ...
  var Ds = function (B) {
    ...
    vs =
      ...
      (xs.prototype.getTime = function () {
        return Date.now() - this.start;
      }),
      (xs.prototype.info = function () {
        for (var A = [], e = 0; e < arguments.length; e++) A[e] = arguments[e];
        this.enabled &&
          "undefined" != typeof window &&
          window.console &&
  ...
  function Ss(A, e) {
    (this.windowBounds = e),
      (this.instanceName = "#" + Ss.instanceCount++),
      (this.logger = new vs({ id: this.instanceName, enabled: A.logging })),
      (this.cache =
        null !== (e = A.cache) && void 0 !== e ? e : new Dn(this, A));
  }
      ...
      return a(void 0, void 0, void 0, function () {
        ...
        return H(this, function (A) {
          switch (A.label) {
            ...
            case 1:
              ...
              (C = {
                ...
                scale:
                  null !==
                    (C =
                      null !== (C = F.scale) && void 0 !== C
                        ? C
                        : t.devicePixelRatio) && void 0 !== C
                    ? C
                    : 1,
                x: (null !== (C = F.x) && void 0 !== C ? C : 0) + s,
                y: (null !== (C = F.y) && void 0 !== C ? C : 0) + o,
                width:
                  null !== (C = F.width) && void 0 !== C ? C : Math.ceil(r),
                height:
                  null !== (C = F.height) && void 0 !== C ? C : Math.ceil(n),
              }),
              c)
                ? (g.logger.debug(
            ...
            case 5:
              return (
                (null !== (l = F.removeContainer) && void 0 !== l && !l) ||
                  wn.destroy(B) ||
                  g.logger.error(
    ...
    Gs = function (A, e, t) {
      var B = e.ownerDocument,
        r = B.documentElement
          ...
          : pe.TRANSPARENT,
        n = B.body
          ? Ce(A, getComputedStyle(B.body).backgroundColor)
          : pe.TRANSPARENT,
        t =
          "string" == typeof t
            ? Ce(A, t)
